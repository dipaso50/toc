...
// Ensure, that OrganizeByTypeMock does implement OrganizeByType.
// If this is not the case, regenerate this file with moq.
var _ OrganizeByType = &OrganizeByTypeMock{}

// OrganizeByTypeMock is a mock implementation of OrganizeByType.
//
// 	func TestSomethingThatUsesOrganizeByType(t *testing.T) {
//
// 		// make and configure a mocked OrganizeByType
...
// 		}
//
// 		// use mockedOrganizeByType in code that requires OrganizeByType
// 		// and then make assertions.
//
// 	}
type OrganizeByTypeMock struct {
...
func (mock *OrganizeByTypeMock) CreateDirectory(dirname string) error {
	if mock.CreateDirectoryFunc == nil {
		panic("OrganizeByTypeMock.CreateDirectoryFunc: method is nil but OrganizeByType.CreateDirectory was just called")
	}
	callInfo := struct {
		Dirname string
	}{
...
//     len(mockedOrganizeByType.CreateDirectoryCalls())
func (mock *OrganizeByTypeMock) CreateDirectoryCalls() []struct {
	Dirname string
} {
	var calls []struct {
		Dirname string
...
func (mock *OrganizeByTypeMock) ExistsDirectory(dirname string) (bool, error) {
	if mock.ExistsDirectoryFunc == nil {
		panic("OrganizeByTypeMock.ExistsDirectoryFunc: method is nil but OrganizeByType.ExistsDirectory was just called")
	}
	callInfo := struct {
		Dirname string
	}{
...
// Check the length with:
//     len(mockedOrganizeByType.ExistsDirectoryCalls())
func (mock *OrganizeByTypeMock) ExistsDirectoryCalls() []struct {
	Dirname string
} {
	var calls []struct {
		Dirname string
...
func (mock *OrganizeByTypeMock) IterateOverDirectory(dirname string, fn Move) error {
	if mock.IterateOverDirectoryFunc == nil {
		panic("OrganizeByTypeMock.IterateOverDirectoryFunc: method is nil but OrganizeByType.IterateOverDirectory was just called")
	}
	callInfo := struct {
		Dirname string
		Fn      Move
...
// Check the length with:
//     len(mockedOrganizeByType.IterateOverDirectoryCalls())
func (mock *OrganizeByTypeMock) IterateOverDirectoryCalls() []struct {
	Dirname string
	Fn      Move
} {
	var calls []struct {
...
func (mock *OrganizeByTypeMock) MoveFile(file domain.FileOrganizer) error {
	if mock.MoveFileFunc == nil {
		panic("OrganizeByTypeMock.MoveFileFunc: method is nil but OrganizeByType.MoveFile was just called")
	}
	callInfo := struct {
		File domain.FileOrganizer
	}{
...
// Check the length with:
//     len(mockedOrganizeByType.MoveFileCalls())
func (mock *OrganizeByTypeMock) MoveFileCalls() []struct {
	File domain.FileOrganizer
} {
	var calls []struct {
		File domain.FileOrganizer
